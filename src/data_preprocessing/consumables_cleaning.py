...
----------------------
Cleaning pipeline for: Consumables Report - Oct. 2022.xlsx
Dataset order: 6

Run:
    python src/data_preprocessing/consumables_cleaning.py
"""

import pandas as pd
from pathlib import Path

RAW_PATH = Path("data/raw/Consumables Report - Oct. 2022.xlsx")
CLEANED_PATH = Path("data/cleaned/consumables_report_cleaned.csv")
